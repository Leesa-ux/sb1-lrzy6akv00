...
export default function AfroeUnifiedLanding(): JSX.Element {
      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <section className="max-w-7xl mx-auto px-4 md:px-6 py-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6">
              <Image src="/images/hero-desert-beauty-real.jpg" alt="Visuel Afroé Glow — beauté Afro moderne" width={600} height={400} className="rounded-2xl shadow-[0_0_30px_rgba(255,0,153,.25)] mx-auto md:mx-0" />
            </div>
