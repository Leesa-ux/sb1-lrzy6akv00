    ...
    <div id="recompenses" className="glassy rounded-2xl p-5 text-white">
      ...
      <div className={clsx("grid gap-4 mt-4", showSecretTier ? "grid-cols-1 md:grid-cols-2" : "grid-cols-1 sm:grid-cols-2 md:grid-cols-3")}>
        <TierCard
          ...
          name="Glow Starters"
          points="10 pts"
          context="Pour tes 2 premiers parrainages"
          benefits={[
            ...
            <div className="space-y-6">
              ...
              <div className="glassy rounded-2xl p-5 border border-fuchsia-400/20">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-white text-base md:text-lg mb-2">Pourquoi Afroé ?</h3>
                    <p className="text-sm text-slate-200 mb-3">
                      10 ans à chercher un coiffeur 4C à la hauteur. J'ai créé Afroé.
                    </p>
                    <p className="text-sm text-slate-100 font-medium mb-3">
                      La beauté afro, sur-mesure. À domicile. Hautement qualifiée.
                    </p>
                    <p className="text-sm text-slate-200 mb-3">
                      🎁 Rejoins la Glow List. Test en avant-première + jusqu'à 3.500€ à gagner via parrainage.
                    </p>
                    <div className="flex flex-col gap-1">
                      <p className="text-xs font-medium text-white">Lisa M.</p>
                      <p className="text-xs text-slate-400">Afro Beauty Tech Thought Leader</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-3">
            <div className="glassy rounded-2xl p-5 text-white">
              ...
              <div className="space-y-4">
                <div>
                  <div className="text-sm font-semibold text-amber-300 mb-2">Avant le lancement (waitlist)</div>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
                    <div className="bg-slate-900/60 border border-white/10 rounded-xl p-3"><div className="text-slate-300">Client·e</div><div className="text-2xl font-bold">+5</div><div className="text-[11px] text-slate-400">Inscription waitlist</div></div>
              ...
              <p className="text-[12px] text-slate-400 mt-3">Les points provisoires sont attribués automatiquement pendant la waitlist. Les points finaux sont calculés après validation (contrôle anti-fraude et vérifications).</p>
            </div>
          ...
          <div className="glassy neon-fuchsia rounded-2xl p-6 md:p-8 text-white text-center">
            <div className="space-y-2">
              <p className="text-lg md:text-xl font-semibold">
                <span className="inline-block">Beauty Pro → « Master It. »</span>
                <span className="mx-2 text-slate-400">•</span>
                <span className="inline-block">Client.e.s → « Own It. »</span>
              </p>
            </div>
